...
class CourseDetailResponseEntity {
  ...
  factory CourseDetailResponseEntity.fromJson(Map<String, dynamic> json) =>
      CourseDetailResponseEntity(
        code: json["code"],
        msg: json["msg"],
        data: CourseItem.fromJson(json["data"][0]),
      );
}
...
class CourseItem {
  ...
  factory CourseItem.fromJson(Map<String, dynamic> json) =>
      CourseItem(
        ...
        lesson_num: json["lesson_length"],
        video_len: json["video_length"],
        downloadable_resources: json["downloadable_resources"],
        follow: json["follow"],
        score: json["score"].runtimeType != Null
